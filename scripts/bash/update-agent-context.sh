...
CURSOR_FILE="$REPO_ROOT/.cursor/rules/nuaa-rules.mdc"
QWEN_FILE="$REPO_ROOT/QWEN.md"
AGENTS_FILE="$REPO_ROOT/AGENTS.md"
WINDSURF_FILE="$REPO_ROOT/.windsurf/rules/nuaa-rules.md"
KILOCODE_FILE="$REPO_ROOT/.kilocode/rules/nuaa-rules.md"
AUGGIE_FILE="$REPO_ROOT/.augment/rules/nuaa-rules.md"
ROO_FILE="$REPO_ROOT/.roo/rules/nuaa-rules.md"
CODEBUDDY_FILE="$REPO_ROOT/CODEBUDDY.md"
AMP_FILE="$REPO_ROOT/AGENTS.md"
Q_FILE="$REPO_ROOT/AGENTS.md"

# Template file
TEMPLATE_FILE="$(resolve_template_path 'agent-file-template.md' "$REPO_ROOT")"
...
validate_environment() {
    ...
    log_warning "Creating new agent files will fail. Run 'nuaa init' or add .nuaa/templates/agent-file-template.md manually."
    fi
}
