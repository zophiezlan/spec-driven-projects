...
$CURSOR_FILE = Join-Path $REPO_ROOT '.cursor/rules/nuaa-rules.mdc'
$QWEN_FILE = Join-Path $REPO_ROOT 'QWEN.md'
$AGENTS_FILE = Join-Path $REPO_ROOT 'AGENTS.md'
$WINDSURF_FILE = Join-Path $REPO_ROOT '.windsurf/rules/nuaa-rules.md'
$KILOCODE_FILE = Join-Path $REPO_ROOT '.kilocode/rules/nuaa-rules.md'
$AUGGIE_FILE = Join-Path $REPO_ROOT '.augment/rules/nuaa-rules.md'
$ROO_FILE = Join-Path $REPO_ROOT '.roo/rules/nuaa-rules.md'
$CODEBUDDY_FILE = Join-Path $REPO_ROOT 'CODEBUDDY.md'
$AMP_FILE = Join-Path $REPO_ROOT 'AGENTS.md'
$Q_FILE = Join-Path $REPO_ROOT 'AGENTS.md'

$TEMPLATE_FILE = Join-Path $REPO_ROOT '.nuaa/templates/agent-file-template.md'
